    ...
    this.findIssue = function(issueNumber, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (response.statusCode === 401) {
                callback(response.statusCode + ': Unauthorized Error');
                return;
            }

            if (response.statusCode === 403) {
                callback(response.statusCode + ': Forbidden');
                return;
            }
    ...
    this.searchJira = function(searchString, optional, callback) {
        ...
        var options = {
            ...
            body: {
                ...
                maxResults: optional.maxResults || 1000,
...
// [Jira Doc](http://docs.atlassian.com/jira/REST/latest/#id290791)
    ...
    // ## Find an issue watchers in jira ##
    // ### Takes ###
    //
    // *  issueNumber: the issueNumber to find
    // *  callback: for when it's done
    ...
    //
    // [Jira Doc](http://docs.atlassian.com/jira/REST/latest/#id290709)
    this.findWatchers = function(issueNumber, callback) {

        var options = {
            rejectUnauthorized: this.strictSSL,
            uri: this.makeUri('/issue/' + issueNumber + '/watchers'),
            method: 'GET'
        };
    ...
    // ## Add watcher of issue in Jira ##
    // ### Takes ###
    //
    // *  issueId: the Id of the issue to delete
    // *  watchers: update Object
    // *  callback: for when it's done
    //
    // ### Returns ###
    // *  error string
    ...
    //
    // [Jira Doc](http://docs.atlassian.com/jira/REST/latest/#id290878)
    this.addWatcher = function(issueNum, watcher, callback) {
        var options = {
            rejectUnauthorized: this.strictSSL,
            uri: this.makeUri('/issue/' + issueNum + '/watchers'),
            body: "\"" + watcher + "\"",
            method: 'POST',
            followAllRedirects: true,
            json: true
    ...
    // ## Delete watcher of issue in Jira ##
    // ### Takes ###
    //
    // *  issueId: the Id of the issue to delete
    // *  watchers: update Object
    ...
    //
    // [Jira Doc](http://docs.atlassian.com/jira/REST/latest/#id290878)
    this.deleteWatcher = function(issueNum, watcher, callback) {
        var options = {
            rejectUnauthorized: this.strictSSL,
            uri: this.makeUri('/issue/' + issueNum + '/watchers?username=' + watcher),
            method: 'DELETE',
            followAllRedirects: true,
            json: false
        };
