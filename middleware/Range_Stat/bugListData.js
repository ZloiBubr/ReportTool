/**
 * Created by Ilya_Kazlou1 on 3/18/2015.
 */
...
exports.getBugs = function (req, res) {
    ...
    cache.getData("bugListData",function(setterCallback){
...
function parsePages(callback) {
    ...
    Issues.find(request)
        .exec(function (err, bugs) {
            ...
            var viewModels = DateRangeService.getLeaderDelayStatisticVms(bugs, ranges);
